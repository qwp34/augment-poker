...
ㄴ 멀티플레이로 플레이하실 것을 권장드립니다.

> 왜 증강 포커인가?
텍사스 홀덤은 완성도 높은 게임이지만, 지금의 20대에게는 선뜻 손이 가는 장르가 아닙니다. 룰을 익히는 데 시간이 들고, 무엇보다 한 판 한 판의 편차가
크지 않습니다. 좋은 패를 기다리고, 확률을 계산하고, 상대를 읽는 과정은 정교하지만 그만큼 예측 가능한 범위 안에서 움직입니다.
증강포커는 여기에 판마다 규칙이 달라지는 축을 하나 더 얹었습니다. 확률 계산이 무의미해지는 순간을 의도적으로 만들어, “이번 판에 무슨 일이 벌어질지 모른다”는 기대감을 홀덤 위에 올리는 것이 목표였습니다.
